    ...
    public void init() {
                    ...
                    if (dataSnapshot.getValue().equals("null")){
                        ...
                        layout_flag.setVisibility(View.GONE);
                            ...
                            if(before_after_data.equals("false")){
                                preArr.add(key);
                                previousAdapter.addItem(ContextCompat.getDrawable(getActivity(), R.drawable.professor), professor, "\" "+summary+" \"", date, way, place, allow, key);
        ...
        listview1.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                // dialog 세팅
                TextView text_professor = (TextView) dlg_previous.findViewById(R.id.text_professor);
                TextView text_summary = (TextView) dlg_previous.findViewById(R.id.text_summary);
                TextView reservation_date = (TextView) dlg_previous.findViewById(R.id.reservation_date);
                TextView reservation_way = (TextView) dlg_previous.findViewById(R.id.reservation_way);
                TextView reservation_place = (TextView) dlg_previous.findViewById(R.id.reservation_place);
                TextView content = (TextView) dlg_previous.findViewById(R.id.content);
                TextView reservation_state = (TextView) dlg_previous.findViewById(R.id.reservation_state);
                TextView reservation_time = (TextView) dlg_previous.findViewById(R.id.reservation_time);
        ...
        listview2.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                // dialog 세팅
                TextView text_professor = (TextView) dlg_after.findViewById(R.id.text_professor);
                TextView text_summary = (TextView) dlg_after.findViewById(R.id.text_summary);
                TextView reservation_date = (TextView) dlg_after.findViewById(R.id.reservation_date);
                TextView reservation_way = (TextView) dlg_after.findViewById(R.id.reservation_way);
                TextView reservation_place = (TextView) dlg_after.findViewById(R.id.reservation_place);
                TextView content = (TextView) dlg_after.findViewById(R.id.content);
                TextView reservation_state = (TextView) dlg_after.findViewById(R.id.reservation_state);
                TextView reservation_time = (TextView) dlg_after.findViewById(R.id.reservation_time);
                Log.i("position", ""+position);
