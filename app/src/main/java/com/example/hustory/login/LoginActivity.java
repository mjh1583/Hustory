...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onStart() {
        ...
        if(!auto.getString("id", "").equals("") || !auto.getString("pw", "").equals("")){
            ...
            Log.i(TAG, auto.getString("UID", ""));
            auto_loginBTN.setChecked(true);
            startMainActivity();
            Log.i(TAG, "flag :" + GetRole.CONTENT_FLAG + " : " + GetRole.FLAG);
        }
    }
    ...
    private void auto_login(boolean check) {
        ...
        if(check) {
            ...
            auto_editor.putString("UID", currentUser.getUid());
        }
        else {
            auto_editor.clear();
        }
    ...
    public void initRole(String uid) {
        ...
        myRef.child("Member").child(uid).child("R_List").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                Log.i(TAG, "onDataChange2 : " + snapshot.getValue());
        ...
        Log.i("FragmentMain", "onDataChange2 : " + GetRole.FLAG);
        Log.i("FragmentMain", "onDataChange2 : " + GetRole.CONTENT_FLAG);
    }
}
